...
# first 6 residuals of model 1
head(residuals(ndvi2010_2021_gam))
...
```{r more visualisations of HWI and NDVI trends, echo = TRUE, warning = FALSE}
...
```{r plot the model results, echo = TRUE, warning = FALSE}
